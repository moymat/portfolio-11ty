const navbarBurger = document.querySelector(".navbar-burger-icon");
...
function toggleBurgerMenu() {
	if (!navbarBurger.parentNode.classList.contains("open")) {
	...
	navbarBurger.parentNode.classList.toggle("open");
}
